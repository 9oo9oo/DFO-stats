...
describe('avatarRoutes', () => {
    ...
    it('GET /avatar/fetch/:serverId/:jobId/:jobGrowId calls getAvatar and returns JSON', async () => {
        ...
        expect(mockGetAvatar).toHaveBeenCalledWith(expect.objectContaining({ params: { serverId: 's1', jobId: 'j1', jobGrowId: 'g1' } }), expect.any(Object), expect.any(Function));
    ...
    it('GET /avatar/stats/:jobId/:jobGrowId calls getAvatarStats and returns JSON', async () => {
        ...
        expect(mockGetAvatarStats).toHaveBeenCalledWith(expect.objectContaining({ params: { jobId: 'j2', jobGrowId: 'g2' } }), expect.any(Object), expect.any(Function));

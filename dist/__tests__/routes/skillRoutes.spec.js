...
describe('skillRoutes', () => {
    ...
    it('GET /skill/fetch/:serverId/:jobId/:jobGrowId calls fetchSkills and returns JSON', async () => {
        ...
        expect(mockFetchSkills).toHaveBeenCalledWith(expect.objectContaining({ params: { serverId: 's1', jobId: 'j1', jobGrowId: 'g1' } }), expect.any(Object), expect.any(Function));
    ...
    it('GET /skill/stats/:jobId/:jobGrowId calls getSkillStats and returns JSON', async () => {
        ...
        expect(mockGetSkillStats).toHaveBeenCalledWith(expect.objectContaining({ params: { jobId: 'j2', jobGrowId: 'g2' } }), expect.any(Object), expect.any(Function));

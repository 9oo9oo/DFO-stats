...
describe('equipmentRoutes', () => {
    ...
    it('GET /equipment/fetch/:serverId/:jobId/:jobGrowId calls fetchEquipment and returns JSON', async () => {
        ...
        expect(mockFetchEquipment).toHaveBeenCalledWith(expect.objectContaining({ params: { serverId: 's1', jobId: 'j1', jobGrowId: 'g1' } }), expect.any(Object), expect.any(Function));
    ...
    it('GET /equipment/stats/:jobId/:jobGrowId calls getEquipmentStats and returns JSON', async () => {
        ...
        expect(mockGetEquipmentStats).toHaveBeenCalledWith(expect.objectContaining({ params: { jobId: 'j2', jobGrowId: 'g2' } }), expect.any(Object), expect.any(Function));
    ...
    it('GET /equipment/combinations/:jobId/:jobGrowId calls getEquipmentCombinations and returns JSON', async () => {
        ...
        expect(mockGetEquipmentCombos).toHaveBeenCalledWith(expect.objectContaining({ params: { jobId: 'j3', jobGrowId: 'g3' } }), expect.any(Object), expect.any(Function));

...
describe('creatureRoutes', () => {
    ...
    it('GET /creature/fetch/:serverId/:jobId/:jobGrowId calls fetchCreature and returns JSON', async () => {
        ...
        expect(mockFetchCreature).toHaveBeenCalledWith(expect.objectContaining({ params: { serverId: 's1', jobId: 'j1', jobGrowId: 'g1' } }), expect.any(Object), expect.any(Function));
    ...
    it('GET /creature/stats/:jobId/:jobGrowId calls getCreatureStats and returns JSON', async () => {
        ...
        expect(mockGetCreatureStats).toHaveBeenCalledWith(expect.objectContaining({ params: { jobId: 'j2', jobGrowId: 'g2' } }), expect.any(Object), expect.any(Function));
    ...
    it('GET /creature/combinations/:jobId/:jobGrowId calls getCreatureArtifactCombinations and returns JSON', async () => {
        ...
        expect(mockGetCreatureCombos).toHaveBeenCalledWith(expect.objectContaining({ params: { jobId: 'j3', jobGrowId: 'g3' } }), expect.any(Object), expect.any(Function));

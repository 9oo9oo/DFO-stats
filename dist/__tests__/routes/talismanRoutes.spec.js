...
describe('talismanRoutes', () => {
    ...
    it('GET /talisman/fetch/:serverId/:jobId/:jobGrowId calls fetchTalismanAndRunes and returns JSON', async () => {
        ...
        expect(mockFetchTalismanAndRunes).toHaveBeenCalledWith(expect.objectContaining({ params: { serverId: 's1', jobId: 'j1', jobGrowId: 'g1' } }), expect.any(Object), expect.any(Function));
    ...
    it('GET /talisman/stats/:jobId/:jobGrowId calls getTalismanRuneStats and returns JSON', async () => {
        ...
        expect(mockGetTalismanRuneStats).toHaveBeenCalledWith(expect.objectContaining({ params: { jobId: 'j2', jobGrowId: 'g2' } }), expect.any(Object), expect.any(Function));
